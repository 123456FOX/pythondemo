...
while True:
    ...
    if chose.isdigit():
        ...
        if chose > 6:
            ...
            if extract == "y":
                # 5.5 判断您的余额是否足够
                if money < shop[chose][1] & money < shop[chose][1] * discount1 & money < shop[chose][1] * discount2:
                    print("对不起，穷鬼，您的钱不够！请到其他超市买东西去！")

                    if chose == 2 and coupon > 10:
                        # 5.6 将商品添加到购物车 ，余额减去对应的钱
                        myCart.append(shop[chose])
                        money = money - int(shop[chose][1]) * discount1
                        print("恭喜，成功添加购物车！您的余额还剩￥：", money)
                    elif chose == 6 and 0 < coupon <= 10:
                        # 5.6 将商品添加到购物车 ，余额减去对应的钱
                        myCart.append(shop[chose])
                        money = money - int(shop[chose][1]) * discount2
                        print("恭喜，成功添加购物车！您的余额还剩￥：", money)
                    else:
                        myCart.append(shop[chose])
